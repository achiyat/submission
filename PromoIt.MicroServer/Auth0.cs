...
namespace PromoIt.MicroServer
{
    public static class Auth0
    {
        ...
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", "put", "delete", Route = "Auth0/{page?}/{action}/{IdNumber?}")] HttpRequest req, string page, string action, string IdNumber,ILogger log)
        {
            ...
            {
                MainManager.Instance.logger.Error($"Failed Request in Auth0");
